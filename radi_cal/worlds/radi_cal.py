...
UPDATED VERSION: All 4 channels converted to T-type (shower-max) fibers.
"""
...
_CAP_POSITIONS_MM = [
    ...
    [-_HOLE_OFFSET_MM,  _HOLE_OFFSET_MM],   # 2 — T-type (converted from E-type)
    [ _HOLE_OFFSET_MM, -_HOLE_OFFSET_MM],   # 3 — T-type (converted from E-type)
]
_E_TYPE_INDICES  = set()
_T_TYPE_INDICES  = {0, 1, 2, 3}
