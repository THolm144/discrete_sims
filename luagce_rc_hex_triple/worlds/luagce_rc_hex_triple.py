...
- Dynamic calculation of gap sizes, active Z-ranges, total calorimeter depth,
  and WLS filament positioning for Layer 8 within hexagonal volumes.
"""
...
# Filament for T-type capillaries located at Layer 8
