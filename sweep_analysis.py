...
def analyze_energy_batch(batch_dir: Path, is_hex: bool):
    ...
    # ── THE CRITICAL FIX: Track offsets so Event IDs don't overwrite! ──
    global_offset = 0
    ...
    for fpath in hit_files:
        try:
            with uproot.open(fpath) as f:
                ...
                # Shift event IDs for this specific file, then update the offset
        ...
        # WE KEEP THESE! Do not remove the spatial constraints.
