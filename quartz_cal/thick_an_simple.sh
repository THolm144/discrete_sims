...
N_PARTICLES=300
THREADS=400                  # 1 thread per simulation instance (single-threaded)
PARALLEL_RUNS=400          # 300 parallel runs per batch
REPEATS=2                  # Total batches per thickness (1 run + 2 repeats)
BEAM_RADIUS=0.01
OPTICAL="on"
SIPM_HITS="on"
